...
public class VocabularyItemVM {
    ...
    private String mCompletedPercent;
    private Integer mTotalWordsCount;
    private Integer mMistakesCount;
    private Integer mRunCount;

    public VocabularyItemVM(String title, String lastRunDateString, String completedPercent, Integer totalWordsCount, Integer mistakesCount, Integer runCount) {
        mTitle = title;
